          ...
          {data.map((item) => {
            return (
              <tr key={item.id} className={`${style.employees} `}>
                <th onClick={(event) => goUser(event, item.id)} scope="row">
                  {item.id}
                </th>
                <td onClick={(event) => goUser(event, item.id)}>{item.name}</td>
                <td onClick={(event) => goUser(event, item.id)}>{item.surname}</td>
                <td onClick={(event) => goUser(event, item.id)}>{item.email}</td>
                <th onClick={(event) => goUser(event, item.id)}>{item.position}</th>
